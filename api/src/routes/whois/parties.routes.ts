...
import { create_party_async, get_participants_async, get_party_async, get_user_parties_async, get_user_parties_finished_async, join_party_async, read_parties_async } from "../../controllers/whois/parties.controller";
...
router.get('/', authenticate, read_parties_async)
